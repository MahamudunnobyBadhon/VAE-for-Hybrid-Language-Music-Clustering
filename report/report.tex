...
\begin{table}[H]
\centering
\caption{Hard Task results ($\beta\!=\!1$, $d_z\!=\!32$, $K\!=\!10$, $N\!=\!20{,}020$). CVAE conditioned on language+genre one-hot. Spectral baseline evaluated on a 500-sample subsample. VAE models at top, baselines shaded.}
\label{tab:hard}
\small
\begin{tabular}{lrrrrr}
\toprule
\textbf{Method} & \textbf{SS $\uparrow$} & \textbf{CHI $\uparrow$} & \textbf{DBI $\downarrow$} & \textbf{ARI $\uparrow$} & \textbf{NMI $\uparrow$} \\
\midrule
\textbf{CVAE + K-Means} & \textbf{0.595} & 5,025 & \textbf{0.784} & 0.052 & 0.242 \\
\textbf{CVAE + GMM}     & 0.737$^\dagger$ & 2,528 & 0.542$^\dagger$ & 0.041 & 0.101 \\
\textbf{MultiModalVAE + K-Means} & 0.273 & \textbf{26,357} & 1.084 & 0.035 & 0.156 \\
BetaVAE ($\beta\!=\!1$) + K-Means & 0.254 & 14,076 & 1.152 & \textbf{0.105} & \textbf{0.250} \\
\midrule
\rowcolor{gray!15} Autoencoder + K-Means & 0.020 & 632 & 3.113 & 0.170 & 0.378 \\
...
\rowcolor{gray!15} Spectral Clustering ($n\!=\!500$) & 0.029 & 23 & 2.753 & 0.189 & 0.336 \\
\bottomrule
\end{tabular}
\vspace{2pt}
