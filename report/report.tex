...
\caption{Beta-VAE ($\beta\!=\!4$): original vs.\ reconstructed}
\end{subfigure}
\caption{VAE reconstruction examples. Each panel shows original mel-spectrogram feature vectors (top) and their reconstructions decoded from the 32-dim latent space (bottom). CVAE reconstructions preserve fine spectral structure; Beta-VAE reconstructions are smoother due to stronger KL regularisation ($\beta\!=\!4$) collapsing inactive latent dimensions.}
