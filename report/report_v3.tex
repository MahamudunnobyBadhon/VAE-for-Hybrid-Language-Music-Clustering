...
Future work should apply DBSCAN only in the low-dimensional ($d\!\leq\!32$) latent space, or adopt HDBSCAN~\cite{campello2013density} preceded by UMAP dimensionality reduction---the standard practice for density-based clustering in high dimensions.
